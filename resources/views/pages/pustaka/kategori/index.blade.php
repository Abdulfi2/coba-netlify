...
@section('main')
    {{ Breadcrumbs::render('kategori.index') }}
    <div class="content">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="col-sm-3">
                            <span class="input-icon">
                                ...
                                <a class="btn btn-warning btn-white align-middle" href="/kategori">
        ...
        @endif
        <h3 class="mt-3 mb-3" align="center">Data Kategori Aset</h3>
        <div class="card card-info card-outline">
            <div class="card-header p-3">
                <div class="col-12">
                    <a href="/kategori/create" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i> Tambah Data</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="data-table table table-striped table-bordered table-hover row-border border-gray mt-3">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th scope="col">Kode Kategori Aset</th>
                        ...
                        <tbody class="table-group-divider">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a class="btn btn-secondary btn-sm" href='{{ url('/kategori/' . $item->id) }}'><i
                                                class="bx bxs-show"></i> Preview</a>
                                        <a class="btn btn-warning btn-sm" href='{{ url('/kategori/' . $item->id . '/edit') }}'><i
