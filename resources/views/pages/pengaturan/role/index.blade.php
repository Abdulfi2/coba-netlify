...
@section('main')
    ...
    <div class="content">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="col-sm-3">
                            <span class="input-icon">
                                ...
                                <a class="btn btn-warning btn-white align-middle" href="/role">
        ...
        @endif
        <h3 class="mt-3 mb-3" align="center">Data Role User</h3>
        <div class="card card-info card-outline">
            <div class="card-header p-3">
                <div class="col-12">
                    <a href="/role/create" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i> Tambah Data</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td><a class="btn btn-secondary btn-sm" href='{{ url('/role/' . $item->id) }}'><i
                                                class="bx bxs-show"></i> Preview</a>
                                        <a class="btn btn-warning btn-sm" href='{{ url('/role/' . $item->id . '/edit') }}'><i
                                                class="bx bxs-edit"></i> Edit</a>
                                        <form onsubmit="return confirm('Yakin mau menghapus data?')" class="d-inline"
                                            action="{{ url('/role/' . $item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
